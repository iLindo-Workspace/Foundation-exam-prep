...
*We do testing to reduce the level of risk and improve qaulity of a product before it goes live*
...
* Ensure required coverage for Test Object
     * Confirm that enough  testing has been performed, be it Functional(black-box), Structural(white-box), Risk-Based, and Non-funtional. Test Design, Test Execution, Monitoring
* Reduce risks of low software quality
    * Focus on high-risk areas to prevent business failures. Test Planning, Test Execution 
* Verify specified requirements are met
    * Check if the product does what the requirements/specification say. Test Design, Test Execution
* Verify whether the test object complies with legal, contractual, and regulatory requirements
    * Ensure legal, safety and standards are satisfied. System & Acceptance Testing
* Provide information to stakeholeders to allow them to make informed decisions
...
* Validate that the test object is complete and works as expected by the stakeholders
...
- *Debbuging is the process of finding root cause of the defect, analyse it, and fix it.*
...
| Root Cause     | Underlying issues           | In a process of Understanding | during Analysis     | Misintepreted specification |
...
(2. ) Exhaustive Testing is imposible
...
- The ealier the defect is found in the SDLC the Cheaper it is to fix

(4. ) Defects cluster together
- Refers to certain modules being more error-prone than others, so testers focus more effort there.

(5. ) Persticide Paradox/Test Wear Out
...
- Testing depends on the type of sytem(games, aviation software) and risks involved

(7. ) Absence-of-Defect Fallacy
- Just because that the software is defect free doesn't mean it meats the business needs
...
(4. ) Provides audit & Complience Evidence
...
(5. ) Fascilitates Reporting and Decision Making
...
<h1 align="center">Issential Skills and Good Practices in Testing</h1>
...
- Attention to Details
    - *Carefully noticing small deviations and inconsistancies*
- Critical Thinking
...
- Curiosity/Investigative mindset
    - *Desire to di deeper to understand why something fails rather that doing nothing*
- Risk Awareness
...
- *If the indepencent tester is too rigid, communication suffers, leads to poor/low quality*
